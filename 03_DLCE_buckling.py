...
Lx = 0.34e-3 # m
Ly = Lx/10# m
domain = mesh.create_rectangle(MPI.COMM_WORLD, [[0, 0], [Lx, Ly]], [100, 10], mesh.CellType.quadrilateral)
...
for rate_phi in [1.0]:      # list of all the considered rates of applying the load/voltage/stretch
    ...
    for theta_00_deg in theta_list:
        ...
        for rrr in r_list:
            ...
            # -------------------------------------------------------
            # results file name
            results_name = "2D_DLCE_buckling__r={}__".format(rrr)
...
# ====================================================================================
            ...
            with open(csv_dir_path+"/Buckling__r={}__theta0=5__timehistory_0___t.csv".format(rate_phi, rrr), 'w', newline='') as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow(timeHist0[0:ind])
            csvfile.close()
            
            with open(csv_dir_path+"/Buckling__r={}__theta0=5__timehistory_1___phi.csv".format(rate_phi, rrr), 'w', newline='') as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow(timeHist1[0:ind])
            csvfile.close()

            with open(csv_dir_path+"/Buckling__r={}__theta0=5__timehistory_2___lambda1.csv".format(rate_phi, rrr), 'w', newline='') as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow(timeHist2[0:ind])
            csvfile.close()

            with open(csv_dir_path+"/Buckling____r={}__theta0=5__timehistory_3___theta.csv".format(rate_phi, rrr), 'w', newline='') as csvfile:
                writer = csv.writer(csvfile)
...
# ====================================================================================
            ...
            plt.tight_layout()
            if analysis_type=="theta_fixed":
                plt.savefig(figs_dir_path+"/Fig_Buckling____rate={}____r__theta0={}___lambda-phi.png".format(rate_phi, theta_00_deg), dpi=600)
            if analysis_type=="r_fixed":
                plt.savefig(figs_dir_path+"/Fig_Buckling____rate={}____theta0__r={}___lambda-phi.png".format(rate_phi, rrr), dpi=600)
...
# ====================================================================================
            ...
            if analysis_type=="theta_fixed":
                plt.savefig(figs_dir_path+"/Fig_Buckling____rate={}____r__theta0={}___theta-phi.png".format(rate_phi, theta_00_deg), dpi=600)
            if analysis_type=="r_fixed":
                plt.savefig(figs_dir_path+"/Fig_Buckling____rate={}____theta0__r={}___theta-phi.png".format(rate_phi, rrr), dpi=600)
